...
# mkdir flair/label
# animaApplyTransformSerie -g flair/flair_brain.nii.gz -i ${FSLDIR}/data/standard/MNI152_T1_1mm_brain.nii.gz -t flair/mni2flair.xml -o flair/label/mni_flair.nii.gz